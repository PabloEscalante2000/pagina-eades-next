    ...
    <div className="overflow-x-hidden">
      ...
      <section id="propuesta" className="bg-marroncito py-20 px-6 sm:px-16">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 w-full">
            <Image
              src="/ansiedad_eades_blog.jpg"
              alt="Ansiedad y bienestar emocional"
              width={600}
              height={500}
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row-reverse gap-12 items-center">
          ...
          <div className="lg:w-1/2 w-full">
            <Image
              ...
              alt="Evaluación psicológica profesional"
              width={600}
              height={500}
      ...
      <section className="bg-marroncito py-20 px-6 sm:px-16">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row-reverse gap-12 items-center">
          ...
          <div className="lg:w-1/2 w-full flex flex-col items-center gap-3">
            <Image
      ...
      <section className="bg-white py-20 px-6 sm:px-16">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
              ...
              {[
                {
                  icono: "🕒",
                  titulo: "Evaluación",
                  detalle: "60 minutos de evaluación clínica",
                },
                {
                  icono: "📄",
          ...
          <div className="lg:w-1/2 w-full">
            <Image
              src="/virtual.jpg"
              alt="Sesión virtual o presencial EADES"
              width={600}
              height={500}
              className="w-full h-96 object-cover object-center rounded-2xl shadow-lg"
            />
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="lg:w-1/2 w-full lg:sticky lg:top-24">
            <Image
              ...
              width={600}
              height={600}
              className="w-full h-[460px] object-cover object-center rounded-2xl shadow-lg"
            />
          </div>
        </div>
      </section>
