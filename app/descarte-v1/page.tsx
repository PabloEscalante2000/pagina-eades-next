        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-6 pt-4">
            {[
              ...
              <div
                key={i}
                className="bg-white rounded-xl p-6 border-l-4 border-azul space-y-2 shadow-sm"
              >
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="bg-white/10 border border-white/20 rounded-xl p-6 flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <span className="font-open-sans text-white text-xl">
              S/ 160 soles · Modalidad presencial o virtual.
            </span>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                respuesta:
                  "Sí, según la modalidad disponible del servicio.",
              },
            ].map((item, i) => (
              <div
                key={i}
